# Attention-BLSTM emotion classification (Valence)
# Use GP+DIS-NV features, train on both databases and test on a subset of AVEC
...
# data files
file_log = '/Outputs/CC_Att_Both_A_GP+DN_V_log.txt'
file_emo_trn = '/Data/IEMOCAP_emo.csv'
file_feat_trn = '/Data/IEMOCAP_GP+DN.csv'
file_emo_tst = '/Data/utt_AVEC_emo.csv'
file_feat_tst = '/Data/utt_AVEC_GP+DN.csv'
...
tst_emo_raw = pd.read_csv(file_emo_tst, header=None, usecols=[3])

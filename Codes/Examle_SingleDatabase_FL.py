# LSTM emotion classification using Feature Level (FL) fusion features, train and test on IEMOCAP
...
nb_GP_features = 3 # dimensionality of feature set 1
nb_DN_features = 5 # dimensionality of feature set 2
nb_features = nb_GP_features + nb_DN_features # total number of features, also the number of neurons in the input layer of LSTM
...
# read in data
data_feat1 = pd.read_csv(file_feat1, header=None)
data_feat2 = pd.read_csv(file_feat2, header=None)
# concatenate the features (FL fusion)
data_feat = pd.concat(data_feat1, data_feat2], axis=1)
# normalize features
